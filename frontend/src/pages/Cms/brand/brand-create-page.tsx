...
const CreateBrand = () => {
    ...
    const {
      ...
      const onSubmit = async (data:any) => {
        try{
            ...
            await authSvc.postRequest('/Brand',data,{auth:true,file:true});
    ...
    return (
        ...
        <div className="overflow-x-auto mt-5 mb-5">
          <Heading3><>Create Brand</></Heading3>
          <hr/>
          </div>
...
<form onSubmit={handleSubmit(onSubmit)}>
    ...
    <TextInputComponent
            ...
            >Create</SubmitButton>
              ...
              <div>
                  <label htmlFor="Brand" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Brand</label>
                  <select id="Brand" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-500 focus:border-violet-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-violet-500 dark:focus:border-violet-500">
