          ...
          <div className="flex items-center lg:order-2">
              ...
              <div>
                ...
                >
                  <div className="flex-shrink-0">
                    ...
                    />
                    <div className="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white bg-primary-700 dark:border-gray-700"></div>
                  </div>
            ...
            >
              ...
              {LoggedInUser && LoggedInUser.image ? (
                ...
                <>
                  <HiUser className="w-6 h-6 rounded-full bg-slate-300  " />
                </>
              )}
            </button>
