...
const RegisterPage = () => {
  const registerDTO = Yup.object({
    ...
    password: Yup.string()
      .matches(
        /^(?=.*[\d])(?=.*[a-z])(?=.*[A-Z])(?=.*\W)(?!.* ).{8,25}$/,
        "password must contain small letter, capital letter, number and special character",
      )
      .required(),
    ...
    try {
      ...
      if (+exception.status === 400) {
        if (
          ...
          typeof exception.data.result === "object"
        ) {
          ...
          <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div className="max-w-xl lg:max-w-3xl">
              ...
              <p className="mt-4 leading-relaxed text-gray-500">
                ...
                track your orders, and stay updated with our latest deals and
